package com.himanshu.newspoint.remote.networkInterceptors

import com.vinners.core.logger.Logger
import com.himanshu.newspoint.remote.exceptions.ErrorConnectingServerException
import com.himanshu.newspoint.remote.exceptions.InternalServerErrorException
import com.himanshu.newspoint.remote.exceptions.SessionExpiredException
            ...
            when (exception) {
                is IOException -> {
                    ...
                    throw IOException(
                        ...
                        ErrorConnectingServerException(
