package com.himanshu.newspoint.core.mdm
...
object DeviceInfo {
    ...
    fun getDeviceInfo(
        activity: Context,
        device: _root_ide_package_.com.himanshu.newspoint.core.mdm.Device?
    ): String {
        try {
            when (device) {
                _root_ide_package_.com.himanshu.newspoint.core.mdm.Device.DEVICE_LANGUAGE -> return Locale.getDefault().displayLanguage
                _root_ide_package_.com.himanshu.newspoint.core.mdm.Device.DEVICE_HARDWARE_MODEL -> return deviceName
                _root_ide_package_.com.himanshu.newspoint.core.mdm.Device.DEVICE_NUMBER_OF_PROCESSORS -> return Runtime.getRuntime()
                    .availableProcessors().toString() + ""
                _root_ide_package_.com.himanshu.newspoint.core.mdm.Device.DEVICE_TOTAL_MEMORY -> return getTotalMemory(
                    activity
                ).toString()
                _root_ide_package_.com.himanshu.newspoint.core.mdm.Device.DEVICE_FREE_MEMORY -> return getFreeMemory(
                    activity
                ).toString()
                _root_ide_package_.com.himanshu.newspoint.core.mdm.Device.DEVICE_USED_MEMORY -> {
                    val freeMem =
                        getTotalMemory(activity) - getFreeMemory(activity)
                    return freeMem.toString()
                }
                _root_ide_package_.com.himanshu.newspoint.core.mdm.Device.DEVICE_MANUFACTURE -> return Build.MANUFACTURER
                _root_ide_package_.com.himanshu.newspoint.core.mdm.Device.DEVICE_SYSTEM_VERSION -> return deviceName
                _root_ide_package_.com.himanshu.newspoint.core.mdm.Device.DEVICE_VERSION -> return Build.VERSION.SDK_INT.toString()
                _root_ide_package_.com.himanshu.newspoint.core.mdm.Device.DEVICE_IN_INCH -> return getDeviceInch(
                    activity
                ).toString()
                _root_ide_package_.com.himanshu.newspoint.core.mdm.Device.DEVICE_NETWORK_TYPE -> return getNetworkType(
                    activity
                )
                _root_ide_package_.com.himanshu.newspoint.core.mdm.Device.DEVICE_NETWORK -> return checkNetworkStatus(
                    activity
                )
                _root_ide_package_.com.himanshu.newspoint.core.mdm.Device.DEVICE_TYPE -> return if (isTablet(activity)) {
