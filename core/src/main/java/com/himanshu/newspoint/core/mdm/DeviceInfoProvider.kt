...
import com.vinners.newspoint.data.models.mdm.DeviceInformation
import com.vinners.newspoint.data.models.mdm.MobileInformation
import com.vinners.newspoint.data.models.mdm.NetworkInfo
import com.vinners.newspoint.data.models.mdm.OsInformation
    ...
    fun getDeviceInfo(): MobileInformation {
        ...
        deviceInformation.setTotalRam(
            DeviceInfo.getDeviceInfo(
                applicationContext,
                _root_ide_package_.com.himanshu.newspoint.core.mdm.Device.DEVICE_TOTAL_MEMORY
            )
        )
