...
import com.vinners.newspoint.core.QuickAlertDialog
...
abstract class BaseActivity<B : ViewDataBinding,M : ViewModel>(
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        Timber.d("Calling Activity : ${callingActivity?.className}")
        Timber.d("Calling Activity : ${ActivityCompat.getReferrer(this)}")
