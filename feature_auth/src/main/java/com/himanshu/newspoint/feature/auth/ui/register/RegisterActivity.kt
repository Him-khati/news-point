...
import com.vinners.newspoint.core.AppConstants
import com.vinners.newspoint.core.DateTimeHelper
...
import com.vinners.newspoint.feature.auth.databinding.ActivityRegisterBinding
        ...
        viewModel.registerState.observe(this, androidx.lifecycle.Observer {
            when (it) {
                ...
                is Lse.Success -> {
                    ...
                    intent.putExtra(DashBoardActivity.INTENT_USER_NAME, userName)
