...
import com.vinners.newspoint.core.extensions.isDateOlderThanYear
import java.util.*
...
object RegisterValidation {
    ...
    private fun validateCity(cityId: String) {
        registerValidationResult.cityValid = true
        if (cityId.isBlank()) {
            registerValidationResult.cityValid = false
            registerValidationResult.message = " Select valid city"
        }
    }
